function DashboardCard({ label, value, Icon }) {
  return (
    <div className="flex h-[15vh] min-h-25 w-[45vw] min-w-full flex-col justify-between rounded-xl bg-neutral-100 p-4 font-[Poppins] text-neutral-800 inset-shadow-med lg:w-1/5">
      {/** */}
