...
const Card = ({ Ctitle, Cage, Cdesc, Cimg }) => {
  return (
    <div className="flex max-h-80 min-h-75 max-w-70 min-w-60 flex-col gap-y-5 rounded-2xl bg-bone p-3 inset-shadow-med">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-xs text-egg-dark">{Cage}</span>
      </div>
      <div>
